...
func main() {
	...
	for s.Scan() {
		...
		results.Items = append(results.Items, Book{
			Title: matches[0][1],
			URL:   matches[0][2],
		})
	}
...
- [up and going  📖](https://github.com/getify/You-Dont-Know-JS/blob/master/up%20%26%20going/foreword.md)

- [scope and closures 📖](https://github.com/getify/You-Dont-Know-JS/blob/master/scope%20%26%20closures/ch1.md#you-dont-know-js-scope--closures)
